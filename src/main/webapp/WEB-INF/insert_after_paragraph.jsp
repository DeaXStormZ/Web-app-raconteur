...
<div id="page_block">
    ...
    <div class="center all_width">
        <form accept-charset="UTF-8" action="controller" method="post" class="all_width">
            ...
            <label><textarea name="paragraph_text" class="paragraph_edit_field"></textarea></label>

            <br>
            <button name="action" value="submit_choice" class="mid_sized_button shift_down">Valider</button>
        </form>
    </div>
